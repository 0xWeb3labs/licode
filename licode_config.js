...
//config.nuve.superserviceID = '60b89ea7303459f357f58ad7'; // default value: ''
//config.nuve.superserviceKey = '30634'; // default value: ''
...
config.erizoController.publicIP = '192.168.0.172'; //default value: ''
...
//config.erizoController.hostname = 'licode.callpass.cn'; //default value: ''
...
config.erizoController.ssl_key = '/Users/liwei/test/sfu/licode/cert/callpass.cn.key';
config.erizoController.ssl_cert = '/Users/liwei/test/sfu/licode/cert/fullchain.cer';
...
// Use '' to automatically get IP from the interface
config.erizoAgent.publicIP = '192.168.0.172'; //default value: ''
...
config.erizo.stunserver = 'gfax.net'; // default value: ''
...
**********************************************************/
config.basicExample = {};
config.basicExample.port = 3005;  // default value: 3001
config.basicExample.tlsPort = 3002; // default value: 3004
config.basicExample.nuveUrl = 'http://t.callt.net:3300/';
//config.basicExample.nuveUrl = 'http://192.168.0.172:3300/';
